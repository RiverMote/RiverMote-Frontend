    ...
    return (
        <div className="min-h-screen px-6 py-10 flex items-center justify-center">
            <div className="panel p-8 max-w-md text-center">
                <p className="text-xs text-slate-400 uppercase tracking-wider"><img src="404_h2o.png" width="1000" height="1000"></img></p>
                <h1 className="text-2xl text-slate-600 font-semibold mt-2">Page not found</h1>
                <p className="text-sm text-slate-500 mt-3">
                    Sorry, that page seems to have floated away
                </p>
                <NavLink
                    to="/"
